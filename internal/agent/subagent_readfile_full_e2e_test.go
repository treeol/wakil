...
func TestDispatchSubagentReadFileFull(t *testing.T) {
	...
	summary, _, _, _, _, _ := parent.dispatchSubagent(context.Background(), "find ToolResultCap", io.Discard, "", "")
...
func TestSubagentReadFileFullNoWindowedReReads(t *testing.T) {
	...
	summary, _, _, _, _, _ := parent.dispatchSubagent(context.Background(), "read big.go", io.Discard, "", "")
