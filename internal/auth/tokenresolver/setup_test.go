...
// setupTestStoreImpl creates a file-based SQLite DB with all migrations
// applied and returns a tokenstore + cleanup. WAL mode requires a file.
func setupTestStoreImpl(t *testing.T) (*tokenstore.Store, func()) {
	t.Helper()
	dir := t.TempDir()
